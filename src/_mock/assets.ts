...
// ----------------------------------------------------------------------
export const _regions = ['BJP', 'AAM AAdMI PARTY', '	CPI', '	INC', '	INC'];

// ----------------------------------------------------------------------
export const _states = ['Maharashtra', 'tamil nadu', '	karnataka', '	Gujrat', '	UP'];

// ----------------------------------------------------------------------
export const _district = ['Pune', 'Solapur', 'Satara', '	Kolhapur'];
// ----------------------------------------------------------------------
export const _constituency = ['Pune', 'Solapur', 'Satara', '	Kolhapur'];
// ----------------------------------------------------------------------
export const _ageGroups = [
  '18-20',
  '20-25',
  '25-30',
  '30-35',
...
export const _legislativeTitles = [
  '10 Essential Tips for Healthy Living',
  'The Ultimate Guide to Productivity Hacks',
  'Exploring the Hidden Gems of [Destination]',
  'How to Master the Art of Public Speaking',
...
// ----------------------------------------------------------------------
export const _introducedInLsRS = [
  '01-01-2024',
  '02-01-2024',
  '03-01-2024',
  '04-01-2024',
