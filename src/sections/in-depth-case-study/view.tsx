...
const TABLE_HEAD = [
  ...
  { id: 'case', label: 'Case Type', width: 180 },
  { id: 'publishedDate', label: 'Published Date', width: 220 },
...
export default function InDepthCaseView() {
  ...
  return (
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading="In Depth Case Study"
          links={[
            { name: 'Dashboard', href: paths.dashboard.root },
            { name: 'In Depth Case Study', href: paths.dashboard.inDepthCaseStudy.root },
            { name: 'In Depth Case Study Updates' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.inDepthCaseStudy.createDepthCase}
              variant="contained"
              startIcon={<Iconify icon="mingcute:add-line" />}
            >
              Create In Depth Case Study
            </Button>
          }
          sx={{ mb: { xs: 3, md: 5 } }}
        />
