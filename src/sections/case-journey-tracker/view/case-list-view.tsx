...
import CaseSort from '../case-sort';
import CaseSearch from '../case-search';
import CaseListHorizontal from '../case-list-horizontal';
    ...
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.dashboard.caseJourneyTracker.new}
            variant="contained"
      ...
      >
        <CaseSearch
          ...
          hrefItem={(title: string) => paths.dashboard.caseJourneyTracker.root}
        />

        <CaseSort sort={sortBy} onSort={handleSortBy} sortOptions={POST_SORT_OPTIONS} />
      </Stack>
      ...
      <CaseListHorizontal posts={dataFiltered} loading={postsLoading} />
    </Container>
  );
}
