...
import CaseDetailsPreview from './case-details-preview';
...
export default function CaseNewEditForm({ currentPost }: Props) {
      ...
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            <RHFTextField name="title" label="case Title" />

            <Stack spacing={1.5}>
              <Typography variant="subtitle2">Audio File</Typography>
              <RHFTextField name="audio" label="Audio" type="file" />
            </Stack>
    ...
    <>
      ...
      <Grid xs={12} md={8} sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <LoadingButton
          ...
          sx={{ ml: 2 }}
        >
          {!currentPost ? 'Create Case' : 'Save Changes'}
        </LoadingButton>
      </Grid>
    </>
  );
