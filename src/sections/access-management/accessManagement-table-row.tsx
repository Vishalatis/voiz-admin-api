...
import AccessManagementQuickEditForm from './accessManagement-quick-edit-form';
...
export default function AccessManagementTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  const { title, ministry, introducedInLsRS } = row;
