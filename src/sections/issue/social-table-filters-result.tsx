...
import { ISocialTableFilters, ISocialTableFilterValue } from 'src/types/social-issues';

// ----------------------------------------------------------------------

type Props = StackProps & {
  filters: ISocialTableFilters;
  onFilters: (name: string, value: ISocialTableFilterValue) => void;
  //
...
export default function SocialTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
