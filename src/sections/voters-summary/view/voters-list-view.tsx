...
import VotersSummaryList from '../voters-list';
import VotersSummarySearch from '../voters-search';
...
export default function VotersSummaryListView() {
  ...
  const renderFilters = (
    ...
    >
      <VotersSummarySearch
        ...
        hrefItem={(id: string) => paths.dashboard.votersSummary.details(id)}
      />
    </Stack>
  );
    ...
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        ...
        links={[
          ...
          { name: 'Voters Summary List' },
        ]}
        action={
          <Button
            component={RouterLink}
            href={paths.dashboard.votersSummary.new}
            variant="contained"
      ...
      <VotersSummaryList voters={dataFiltered as any} />
    </Container>
  );
}
