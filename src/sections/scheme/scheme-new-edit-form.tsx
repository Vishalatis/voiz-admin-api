...
import SchemeDetailsPreview from './scheme-details-preview';
...
export default function SchemeNewEditForm({ currentPost }: Props) {
      ...
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            <RHFTextField name="title" label="Scheme Title" />
    ...
    <>
      ...
      <Grid xs={12} md={8} sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <LoadingButton
          ...
          sx={{ ml: 2 }}
        >
          {!currentPost ? 'Create Scheme' : 'Save Changes'}
        </LoadingButton>
      </Grid>
    </>
  );
