...
import { INewsReview } from 'src/types/news';

// import DailyNewsReviewList from './news-review-list';
...
export default function PublicPollDetailsReview({
  totalRatings,
  totalReviews,
  ratings,
  reviews,
  ...
  return (
    <>
      ...
      {/* <DailyNewsReviewList reviews={reviews} /> */}
